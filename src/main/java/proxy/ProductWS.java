 ...
 * 
 */
@WebServiceClient(name = "ProductWS", targetNamespace = "http://webservice.demo.example.com/", wsdlLocation = "http://localhost:8088/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName PRODUCTWS_QNAME = new QName("http://webservice.demo.example.com/", "ProductWS");
    ...
    public ProductWebService getProductWebServicePort() {
        return super.getPort(new QName("http://webservice.demo.example.com/", "ProductWebServicePort"), ProductWebService.class);
    }
    ...
    public ProductWebService getProductWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.demo.example.com/", "ProductWebServicePort"), ProductWebService.class, features);
    }
